...
5. [**Windows OS Secure Configuration (SMB Signing & CVE-2013-3900 Mitigation)**](https://github.com/joshmadakor1/lognpacific-public/blob/main/automation/toggle-guest-local-administrators.ps1)
