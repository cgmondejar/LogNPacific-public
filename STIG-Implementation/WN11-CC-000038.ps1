<#
.SYNOPSIS
    This PowerShell script checks if the UseLogonCredential registry value is set to 0 and 
    fixes it if it is missing or incorrect to prevent WDigest from storing credentials in memory.
